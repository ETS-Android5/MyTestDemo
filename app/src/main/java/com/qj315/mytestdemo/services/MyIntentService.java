package com.qj315.mytestdemo.services;
...
import com.qj315.mytestdemo.receiver.AlarmClockReceiver;
 ...
 */
    ...
    public static boolean IsConnect() {
        if (socket != null) {
            Log.i("TAG", "不为空的IsConnect: "+socket.isConnected());
            return socket.isConnected();
        } else {
            Log.i("TAG", "为空IsConnect: "+false);
            return false;
        }
    }
}
