...
//                            Toast.makeText(UpdatePassword.this, "成功", Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(UpdatePassword.this, "查询失败："+e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }else if (up2.isEmpty()||up1.isEmpty()){
                    Toast.makeText(UpdatePassword.this, "原始密码和新密码输入不能为空！", Toast.LENGTH_SHORT).show();
                }
                else {
