...
public class PhoneVerifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("验证码测试");
        Bmob.initialize(PhoneVerifyActivity.this, "08f5717e435ccb57bd2b266c62b30563");
                    ...
                    BmobSMS.requestSMSCode(s, "QJ315", new QueryListener<Integer>() {
                        ...
                        public void done(Integer smsId, BmobException e) {
                            if (e == null) {
                                ...
                                Toast.makeText(PhoneVerifyActivity.this, "发送验证码成功，短信ID：" + smsId, Toast.LENGTH_LONG).show();
                                phonenumber.setText("");
                            } else {

                                Toast.makeText(PhoneVerifyActivity.this, "发送验证码失败：" + e.getErrorCode() + "-" + e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                } else {
                    Toast.makeText(PhoneVerifyActivity.this, "输入不能为空，且为11位数字！", Toast.LENGTH_SHORT).show();
                }
